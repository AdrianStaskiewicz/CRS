...
public class ViewPath {
    public static final String SERVICE_REQUEST_SCREEN = "/views/ServiceRequestScreen.fxml";
    public static final String ADD_EDIT_SERVICE_REQUEST_SCREEN = "/views/ServiceRequestEditScreen.fxml";
